...
export const pillars: Pillar[] = [
  {
    id: "campaign",
    label: "01 / Campaign",
    title: "Google Ads + Facebook Ads campaigns engineered to convert, not just click.",
    subtitle: "Media plan → Content plan → Tracking plan → SOP. Tested weekly.",
    icon: Megaphone,
    description:
      "Every engagement starts with a written media plan, content plan, and tracking plan — not just ads. I build full-funnel Google Ads (Search, PMax, LSA) + Facebook Ads (Advantage+, CAPI) campaigns with a documented creative testing matrix, kill losing ads in 72 hours, and pour budget into winners. Every step has an SOP so the system survives team churn.",
    bullets: [
      "Media plan: Google Ads + Facebook Ads budget split by funnel stage",
      "Content plan: 5-10 creative variants / week, hook-led, tested by angle",
      "Tracking plan: server-side CAPI + offline conversions on every channel",
      "SOP for creative testing, losing-ad kill list, weekly refresh",
    ],
    accent: "fire",
  },
  {
    ...
    icon: Building2,
    description:
      "Most agencies sell you ROAS. I sell you a business that survives scaling. Before I scale Google Ads + Facebook Ads spend, I map your unit economics, contribution margin, cash cycle, and fulfillment capacity — so growth actually shows up in your bank account, not just in your ad account. Every assumption is documented in a one-page business model the team can follow.",
    bullets: [
      ...
      "SOP-ized business model doc the whole team can read",
    ],
    accent: "brand",
  },
  {
    id: "scaling",
    label: "03 / Scaling",
    title: "Scaling Google Ads + Facebook Ads is a system, not a lucky week.",
    subtitle: "Repeatable 3x in 90 days — without ROAS collapsing.",
    icon: TrendingUp,
    description:
      "I scale Google Ads + Facebook Ads by horizontal audience expansion, vertical creative stacking, and disciplined budget laddering. Every scaling step is documented as an SOP so any media buyer on your team can run it. The goal is to make scale boring and predictable — not heroic.",
    bullets: [
      "Horizontal scaling: new audiences, geos, placements on Google + Meta",
      "Vertical scaling: creative volume per winning angle per platform",
      "Budget laddering: 20% bumps every 48-72h, documented in scaling SOP",
  ...
  },
  {
    ...
    icon: BarChart3,
    description:
      "I track the four numbers that actually move a business: revenue, marketing efficiency ratio (MER), blended CAC, and payback period. Everything else — clicks, impressions, even platform ROAS from Google Ads + Facebook Ads — is a leading indicator I use to tune the engine, not a result I celebrate. Every number has a defined SOP for how it's calculated and reported.",
    bullets: [
      "MER (blended ROAS) as source of truth, not Google/Meta ROAS",
      "Payback-period reporting, not 30-day attribution windows",
      "Cohort LTV by acquisition channel (Google Ads vs Facebook Ads)",
      "P&L-aligned spend reporting SOP, weekly",
    ],
    accent: "brand",
  },
  {
    ...
    subtitle: "Tracking plan + GA4 + Server-side = one source of truth.",
    icon: Gauge,
    description:
      "iOS 14.5 killed platform attribution. I rebuild measurement around a written tracking plan — server-side GTM + Conversions API on Google Ads + Facebook Ads, Triple Whale / Hyros for attribution, and modeled conversions — so decisions are made on real revenue, not on what Meta or Google wants you to believe. Your dashboard finally tells the truth.",
    bullets: [
      "Tracking plan: server-side GTM + CAPI on Google Ads + Facebook Ads",
      "Unified warehouse: ad spend + Shopify + Stripe in one model",
      "MMM + incrementality tests for channels above $50k/mo",
      "SOP for weekly measurement review + dashboard refresh",
    ],
    accent: "fire",
  },
  {
    ...
    subtitle: "Google Ads + Facebook Ads + lifecycle + referral — one flywheel.",
    icon: Rocket,
    description:
      "Paid ads alone stop working around month 9. Real growth is a flywheel: Google Ads + Facebook Ads ignite, lifecycle retains, brand compounds, and referral reduces CAC year over year. I build the full machine with documented SOPs for each layer so you stop renting growth and start owning a brand that prints revenue.",
    bullets: [
      "Lifecycle email/SMS SOP that recovers 20-30% of revenue",
      "Brand creative plan that lowers CAC QoQ (not just ROI)",
      "Referral + UGC loops that compound over 12 months",
      "Quarterly growth experiments backlog, ranked by ICE, with SOP",
    ],
    accent: "brand",
  },
];
